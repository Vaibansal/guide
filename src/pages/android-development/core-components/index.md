...
A _android manifest_ contains the information of an app like about activities, content providers, permissions etc. It contains the information of the app that Android system must have before running it. It is a xml type document.
